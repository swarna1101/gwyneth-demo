...
async function main() {
    ...
    // Deploy a simple ERC20 token that anyone can mint (demo only)
    ...
    console.log(`    L2A: Burned ${ethers.utils.formatEther(txLog.amountIn)} CHEESE tokens`);
    console.log(`    L1: Performed swap on L1 DEX`);
    console.log(`    L1: Acquired ${ethers.utils.formatEther(txLog.amountOut)} SLOTH tokens`);
    console.log(`    L2A: Minted ${ethers.utils.formatEther(txLog.amountOut)} SLOTH tokens`);
